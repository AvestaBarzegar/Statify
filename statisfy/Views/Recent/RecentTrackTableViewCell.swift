...
class RecentTrackTableViewCell: UITableViewCell {
    ...
    static let identifier = "RecenTrackTableViewCell"
    static let cellHeight: CGFloat = 108
        ...
        private func setup() {
            ...
            NSLayoutConstraint.activate([
                ...
                songTitleLabel.leftAnchor.constraint(equalTo: containerView.leftAnchor, constant: 16),
                songTitleLabel.topAnchor.constraint(equalTo: songImage.topAnchor, constant: 4),
                songTitleLabel.rightAnchor.constraint(equalTo: songImage.leftAnchor, constant: -16),
                artistLabel.bottomAnchor.constraint(equalTo: songImage.bottomAnchor, constant: -4),
                artistLabel.leftAnchor.constraint(equalTo: songTitleLabel.leftAnchor),
                artistLabel.rightAnchor.constraint(equalTo: songTitleLabel.rightAnchor)
            ])
        }
