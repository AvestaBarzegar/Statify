...
extension ArtistViewController {
    ...
    private func getInformation() {
        let controllerName = ViewControllerNames.topArtists.rawValue
    ...
    private func fetchMockInfo() {
        ...
        manager.fetchTopArtistsMock(timeRange: .shortTerm) { [weak self] short in
        ...
        manager.fetchTopArtistsMock(timeRange: .mediumTerm) { [weak self] medium in
